...
<head>
    ...
    <link href="{{url("assets/plugins/tabstylesinspiration/css/tabs.css")}}" rel="stylesheet" type="text/css">
    <link href="{{url("assets/plugins/tabstylesinspiration/css/tabstyles.css")}}" rel="stylesheet" type="text/css">
    <link href="{{url("assets/plugins/pricing-tables/css/style.css")}}" rel="stylesheet" type="text/css">
    <link href="{{url("assets/css/landing.css")}}" rel="stylesheet" type="text/css"/>

    <script src="{{url("assets/plugins/pricing-tables/js/modernizr.js")}}"></script>
...
<script src="{{url("assets/plugins/wow/wow.min.js")}}"></script>
<script src="{{url("assets/plugins/tabstylesinspiration/js/cbpfwtabs.js")}}"></script>
<script src="{{url("assets/plugins/pricing-tables/js/main.js")}}"></script>
